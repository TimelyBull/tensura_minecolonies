...
| `rivalNaturalGeneration` | `true` | Whether faction [settlements](../features/rival-colonies.md) appear as you explore — both the faction towns and the dwarf villages that become Dwargon settlements. Off: no settlement ever forms on its own, and faction bosses stay free-roaming wild bosses. |
